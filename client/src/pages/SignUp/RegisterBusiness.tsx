...
import type { BusinessRegisterFormData } from "../../types/types";
    ...
    <div className="h-screen w-screen overflow-hidden bg-white flex flex-col lg:flex-row">
      <div className="h-full w-full lg:w-[45%] p-2 sm:p-4 lg:p-6">
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-4">
          ...
          <span className="text-base sm:text-lg font-extralight font-inter">Business User</span>
        </div>

        <div className="max-w-[450px] mx-auto border border-black sm:border-2 rounded-lg sm:rounded-xl p-3 sm:p-4">
          <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-center mb-2">REGISTRATION</h2>
          ...
          >
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Owner Name</label>
              <input
                type="text"
                name="ownerName"
            ...
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Company Name</label>
              <input
                type="text"
                name="companyName"
                placeholder="Abc"
            ...
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">E-mail</label>
              <input
                type="email"
                name="email"
            ...
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Password</label>
            ...
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Registration Number</label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Pan Card</label>
              <div className="relative">
                ...
                >
                  <span className="bg-[#FF5454] text-white px-3 h-full flex items-center">Choose File</span>
                  <span className="px-2 sm:px-3 truncate text-gray-500">{fileName || "Upload the image"}</span>
                </label>
              </div>
              {errors.panCard && <p className="text-red-500 text-xs">{errors.panCard}</p>}
            </div>

            <div className="space-y-1">
              <label className="block text-sm lg:text-base font-medium">Business Type</label>
              <input
                type="text"
                name="businessType"
      ...
      <div className="hidden lg:block lg:w-[55%] relative">
        ...
        <div className="absolute left-[10%] top-[8%] w-[60%] h-[60%]">
          <img
            src="/business.png"
            alt="Business"
